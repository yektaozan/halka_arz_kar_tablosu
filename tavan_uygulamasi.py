...
def calculate_lot_count_and_budget(initial_price, number_of_lots):
    ...
    number_of_parts = ['1 milyon', '1.2 milyon', '1.5 milyon', '1.7 milyon',
                       '2 milyon', '2.1 milyon', '2.2 milyon', '2.4 milyon', '2.5 milyon', '3 milyon', '3.5 milyon', '3.7 milyon', '4 milyon']
...
#    st.title('Halka Arz Tavan Uygulaması')
    ...
    col1, col2, col3 = st.columns([0.1, 0.5, 0.1])
    ...
    img2 = Image.open("akinci_yatirim.png").resize((1600,800))
    st.image(img2, caption='Bu uygulama Akıncı Yatırım tarafından hazırlanmıştır.', width=200)
